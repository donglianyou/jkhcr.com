...
require SysGlbCfm_DATA . '/config.inc.php';
...
$SystemGlobalcfm_starttime = $mtime[1] + $mtime[0];
$timestamp = time();
...
require_once SysGlbCfm_INC . '/template.fun.php';
require_once SysGlbCfm_INC . '/custom.fun.php';
