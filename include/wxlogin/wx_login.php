...
include QQ3479015851_DATA . '/config.php';
include QQ3479015851_DATA . '/config.db.php';
$actionkey = $timestamp . rand(0, 100);
$url = base64_encode($qq3479015851_global['SiteUrl'] . '/include/wxlogin/wxlogin.php?actionkey=' . $actionkey);
echo '<!DOCTYPE html>' . "\r\n" . '<html>' . "\r\n" . '<head>' . "\r\n" . '<meta charset=utf-8"';
echo $charset;
echo '" />' . "\r\n" . '<title>';
echo $qq3479015851_global['SiteName'];
echo ' - 会员登陆</title>' . "\r\n" . '<script>var nowdomain="';
echo $qq3479015851_global['SiteUrl'];
