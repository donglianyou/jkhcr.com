...
if (empty($_FILES) === false) {
	...
	if ($_FILES[$name_file]['name']) {
		...
		$db->query('INSERT INTO `' . $db_qq3479015851 . 'upload` (title,url,width,height,filesize,uptime,adminid) VALUES (\'' . $qq3479015851_image[0] . '\',\'' . $imgsrcValue . '\',\'' . $imgwidthValue . '\',\'' . $imgheightValue . '\',\'' . $imgsize . '\',\'' . $nowtime . '\',\'' . $admin_id . '\')');
