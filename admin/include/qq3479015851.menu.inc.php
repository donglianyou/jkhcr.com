...
$admin_menu[siteabout][group][element]['新闻资讯']['新闻管理'] = 'news.php';
$admin_menu[siteabout][group][element]['新闻资讯']['新闻类别'] = 'channel.php';
$admin_menu[siteabout][group][element]['新闻资讯']['新闻评论'] = 'news_comment.php';
$admin_menu[siteabout][group][element]['协会专栏']['文章列表'] = 'xiehui.php';
$admin_menu[siteabout][group][element]['协会专栏']['协会类别'] = 'xhchannel.php';
$admin_menu[siteabout][group][element]['协会专栏']['所有评论'] = 'xiehui_comment.php';
$admin_menu[siteabout][group][element]['展会']['文章列表'] = 'zhanhui.php';
$admin_menu[siteabout][group][element]['展会']['展会类别'] = 'zhchannel.php';
$admin_menu[siteabout][group][element]['展会']['所有评论'] = 'zhanhui_comment.php';
