...
$cfg_if_tpledit = ($qq3479015851_qq3479015851[cfg_if_tpledit] == 0 ? '<font color=green>关闭</font>' : '<font color=red>开启</font>');
$if_del_install = (!(is_file(QQ3479015851_ROOT . '/install/index.php')) ? '<font color=green>已删除</font>' : '<font color=red>未删除</font>');
