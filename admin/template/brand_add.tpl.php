...
<?php if(!$admin_cityid){?>
  ...
  <tr bgcolor="#f5fbff">
    ...
    <td>
       <iframe src="/admin/include/upfile.php?watermark=0&adv=1" width="450" frameborder="0" scrolling="no" onload="this.height=iFrame1.document.body.scrollHeight" id="iframe" style=" margin-top:10px"></iframe>
