...
<center><input type="button" onclick="history.go(-1);" value="< 返回" class="gray large"/> &nbsp; <input name="<?=CURSCRIPT?>_submit" type="submit" value="下一步 >" class="qq3479015851 large"/></center>
</form>
<?php }else{?>
...
<center>
<input type="submit" name="<?=CURSCRIPT?>_submit" value="下一步" class="qq3479015851 large"/>
&nbsp;&nbsp;
</center>
</form>
<?php }?>
