...
<center><input class="qq3479015851 large" type="submit" value="上 传" name="focus_submit"> <input onClick="history.back(-1);" class="gray large" type="button" value="返 回"></center>
</form>
