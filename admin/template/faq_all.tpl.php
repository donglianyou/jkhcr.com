...
&nbsp;&nbsp;&nbsp;&nbsp;
      <input class="qq3479015851 mini" type="button" onClick="location.href='faq.php?part=add'" value="发布帮助主题">
	</ul>
</div>
...
<center><input type="submit" onClick="if(!confirm('确定要操作吗？\n\n此操作不可以恢复！'))return false;" value="提 交" class="qq3479015851 large"/></center>
</form>
