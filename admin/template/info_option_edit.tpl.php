...
<?php echo get_qq3479015851_admin_info_type();?>

</div>
<center><input type="submit" value="保存修改" class="qq3479015851 mini"/> <input type="button" onclick="location.href='?classid=<?=$edit[classid]?>';" value="返 回" class="qq3479015851 mini"></center>
</form>
