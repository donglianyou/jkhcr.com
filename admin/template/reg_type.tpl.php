...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
    ...
    <tr bgcolor="#f5fbff" onMouseOver="this.className='Ipt IptIn'"  onmouseout="this.className='Ipt'">
      ...
      <td align="center">
	  <input type="submit" value="更 改" class="qq3479015851 mini"/>　<input type="button" onClick="location.href='friendlink_type.php?part=delete&typeid=<?=$row[id]?>'" value="删 除" class="qq3479015851 mini"/>	   </td>
    </tr>
    </form>
    <?php
	}
    ...
    <tr bgcolor="#f5fbff" onMouseOver="this.className='Ipt IptIn'"  onmouseout="this.className='Ipt'">
      ...
      <td align="center">
      <input type="submit" name="submit" value="新 增" class="qq3479015851 mini"/>
        </td>
    </tr>
   </form>
    <tr>
      <td height="34" colspan="5" align="center" bgcolor="white">
      　<input type="button" onClick=history.back() value="返 回" class="qq3479015851 mini">    </td>
    </tr>
