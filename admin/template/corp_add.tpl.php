...
<center>
<input type="submit" name="<?=CURSCRIPT?>_submit" value="提交保存" class="qq3479015851 mini"/>
&nbsp;&nbsp;
<input type="button" onClick=history.back() value="返 回" class="qq3479015851 mini"></center>
</form>
