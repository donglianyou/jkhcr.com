...
<?php if(!$admin_cityid){?>
  ...
  <? }?>
    ...
    <tr bgcolor="#ffffff">
      ...
      <td><input name="money_own" type="text" class="txt" value="<?=$edit[money_own]?>"/> <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"></td>
    </tr>
    <tr bgcolor="#ffffff">
      <td height="30">积分：</td>
...
<center><input type="submit" class="qq3479015851 mini" value="提 交">
                　<input type="button" onClick="location.href='member.php?if_corp=1'"  class="qq3479015851 mini" value="返 回"></center>
</form>
