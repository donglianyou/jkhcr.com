...
<center style='margin-bottom:10px'><input name="news_submit" value="<?php echo $part == 'edit'? '保存修改' : '提交发布'?>" type="submit" class="qq3479015851"/>&nbsp;&nbsp;<input name="news_submit" value="返 回" type="button" onClick="location.href='?part=list'" class="qq3479015851"/></center>
</form>
