...
<center><input type="submit" name="<?=CURSCRIPT?>_submit" class="qq3479015851 large" value="提 交"/><br /><br /><a href="adv.php?type=<?php echo $type?type:$edit[type]; ?>&cityid=<?=$edit[cityid]?>" class="back">返回<?php echo $type ? $vbm_adv_type[$type][name] : $vbm_adv_type[$edit[type]][name];?>管理</a><br />
