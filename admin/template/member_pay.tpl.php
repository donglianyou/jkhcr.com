...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="vbm">
    ...
    <tr bgcolor="#ffffff">
        ...
        <td>
           <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"> <b><?=$row['money_own']?></b>
        </td>
    </tr>
    <tr bgcolor="#ffffff">
...
<input type="button" onClick="location.href='member.php?if_corp=<?=$row['if_corp']?>'"  class="qq3479015851 mini" value="返 回"></center>
</form>
<div class="clear"></div>
<div class="clear"></div>
<div id="<?=SysGlbCfm_SOFTNAME?>">
