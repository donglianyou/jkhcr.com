<html>
  ...
  <head>
    ...
    <script>var menus = new Array('index', 'info', 'member', 'category', 'news', 'siteabout', 'sitesys', 'plugin', 'extend');
      ...
      var framRight = window.parent.window.document.getElementById("framRight");</script>
  ...
  <body class="top" onLoad="sethighlight('0')">
    ...
    <div class="afterlogonav">
      <div class="left1">
        <a href="../" target="_blank">网站首页</a></div>
      <div class="left2">
        <a href="#" onClick="parent.framRight.location='?do=manage&part=right'">后台首页</a></div>
      <div class="left3">
        <span>您好!
          <font color="#FF6600">
            <?php echo $admin_name?></font>。您的IP是：
          <font color="#FF6600">
            <?php echo GetIP(); ?></font>，管理员级别是
          <font color="#FF6600">
            <?php echo get_admin_type()?></font>，管理员帐号是
          <font color="#FF6600">
