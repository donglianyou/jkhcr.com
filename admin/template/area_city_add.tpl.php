...
对于多个分站,要使用二级域名的话,需要把你的域名泛解释到当前服务器所在IP .如：“*.qq3479015851.com.cn”，泛解释域名必须是*号开头的.一切设置好之后,需要重启服务才会生效.
  </td>
</tr>
<tr bgcolor="#ffffff">
...
<tr bgcolor="#ffffff">
 ...
 <div style="color:#666; margin-top:5px">末尾请务必接"<font color="red">/</font>"，
  如: <font style="text-decoration:underline">http://beijing.qq3479015851.com.cn/</font>
  <br /><font color="red">若不启用二级域名形式，请留空</font>
  <br />填写二级域名后你可以用&nbsp; <b style="color:#006acd; text-decoration:underline">http://beijing.qq3479015851.com.cn/</b> &nbsp;来访问此分站</div></td>
</tr>
<tr bgcolor="#ffffff">
  <td>地图标注起始坐标：</td>
...
<tr bgcolor="#ffffff">
  <td >城市排序： </td>
  <td><input name="citynew[displayorder]" class="txt" type="text" value="<?=$db -> getOne("SELECT MAX(displayorder) FROM `{$db_qq3479015851}city`")?>"></td>
</tr>
<tr bgcolor="#ffffff">
  <td >热门城市？ </td>
...
<center>
<input type="submit" name="<?=CURSCRIPT?>_submit" value="提交" class="qq3479015851 large"/>
&nbsp;&nbsp;
</center>
</form>
