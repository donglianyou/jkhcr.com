...
<?php foreach($news AS $row){?>
    ...
    <td align="left"><a href="../news.php?id=<?=$row[id]?>" target="_blank" title="<?=$row['title']?>"><?=cutstr($row['title'],41)?></a></td>
...
<center><input type="submit" value="提 交" class="qq3479015851 large" name="news_submit"/></center>
</form>
<div class="clear"></div>
