...
<tr>
	<td colspan="2" bgcolor="white">
      ...
      标题 
        ...
        作者 
        <input name="author" class="text" type="text" size="15" value="<?php echo $author; ?>">　<input type="submit" value="检索公告" class="gray mini"> &nbsp;&nbsp;<input type="button" class="qq3479015851 mini" onClick="location.href='announce.php?part=add'" value="发布公告">
       </form>
	</td>
</tr>
</table>
...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
  <form name='form1' method='post' action='announce.php' onSubmit='return checkSubmit();'>
    ...
    <td colspan="10">　
<input type="submit" onClick="if(!confirm('确定要操作吗？\n\n此操作不可以恢复！'))return false;" value="批量删除" class="qq3479015851 mini"/>      
    </td>
    </tr>
  </form>
</table>
