    ...
    <div class="mpstopic-category">
        <div class="panel-tab">
            <ul class="clearfix tab-list">
                <li><a title="已添加的协会类别" href="channel.php">已添加的协会类别</a></li>
                <li><a title="新增协会类别" href="channel.php?part=add">新增协会类别</a></li>
				<li><a title="编辑协会类别" href="channel.php?part=edit&catid=<?=$catid?>" class="current">编辑协会类别</a></li>
            </ul>
        </div>
    </div>
</div>
...
<tr bgcolor="#f5fbff">
  ...
  <td> <input name="title" type="text" class="text" id="title" value="<?=$cat[title]?>" size="50"> <font color="red">*</font>(<font style="color:#FF6600">范例：郑州本地协会_郑州电脑协会</font>,不超过15个字符)
  </td>
</tr>
<tr bgcolor="#f5fbff">
  <td>关键词(keyword)： </td>
