...
<style>
.qq3479015851_td td{ background-color:#ffffff}
...
<table width="100%" cellspacing="0" cellpadding="0" class="vbm">
      ...
      <tbody id="menu_1" class="qq3479015851_td">
	  <tr>
	  ...
	  <?php if(is_array($post[qq3479015851_extra_value])){
	  	foreach($post[qq3479015851_extra_value] as $k => $v){
	  ?>
	  <tr>
	  ...
	  <div class="qq3479015851_td" style="margin-top:3px">
	  <?=$acontent?>
	  </div>
</div>
<div id="<?=QQ3479015851_SOFTNAME?>">
<table width="100%" cellspacing="0" cellpadding="0" class="vbm">
      ...
      <tbody id="menu_2" class="qq3479015851_td">
      <tr>
...
<table width="100%" cellspacing="0" cellpadding="0" class="vbm">
     <tr class="firstr">
      ...
      <tbody id="menu_3" class="qq3479015851_td">
      <tr class="qq3479015851_td">
      <td colspan="2">
		<?=$post[upload_img]?>
      </td>
      </tr>
...
<table width="100%" cellspacing="0" cellpadding="0" class="vbm">
     <tr class="firstr">
      ...
      <tbody id="menu_4" class="qq3479015851_td">
        <?=$post[manage_pwd]?>
        <tr>
...
&nbsp;
<input type="submit" name="qq3479015851" value="修 改" class="qq3479015851 large" />
