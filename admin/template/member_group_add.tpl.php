...
<form name="form1" action="member.php?do=group&part=insert" onSubmit="return checkSubmit();" method="post">
  ...
  <?php echo qq3479015851_member_purview();?>
  <tr class="firstr">
  <td colspan="4">其它设置</td>
  </tr>
  <tr bgcolor="#f5fbff">
    <td height="30">默认拥有金币数</td>
    <td ><input name="money_own" type="text" class="txt" value=""/> <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"> </td>
  </tr>
  <tr bgcolor="#f5fbff">
...
<input name="settings[ifopen][<?php echo $k; ?>]" type="checkbox" class="checkbox" value="1" checked="checked">启用 <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"> <input name="settings[money][<?php echo $k; ?>]" class="txt" value=""> <?php echo $v; ?>
    </div>
    <?php }?>
</td>
  </tr>
