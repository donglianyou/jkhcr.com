...
<?php foreach($option as $k =>$value){?>
	...
	<center><input type="submit" onClick="if(!confirm('确定要操作吗？\n\n此操作不可以恢复！'))return false;" value="提 交" class="qq3479015851 large" name="deloption"/></center>
</form>
...
<center><input type="submit" value="提交" class="qq3479015851 large" name="optionnew"/></center>
</form>
