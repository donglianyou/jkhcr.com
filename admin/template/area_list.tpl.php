...
<div id="<?=SysGlbCfm_SOFTNAME?>">
    ...
    <?}?>
		...
		<tr bgcolor="white">
			<td colspan="9">
            <input name="<?=CURSCRIPT?>_submit" type="submit" value="提交" class="qq3479015851 large"/>&nbsp;&nbsp;&nbsp;&nbsp;
...
<center><input name="<?=CURSCRIPT?>_submit" type="submit" value="提交" class="qq3479015851 large" onClick="if(!confirm('删除操作将同步删除隶属该区域的街道路段，您确定您要继续吗？'))return false;"/></center>
</form>
<div class="clear"></div>
