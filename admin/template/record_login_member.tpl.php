...
<form action="?" name="form1" method="get">
		...
		<input type="button" value="只保存最近两个月的记录" class="qq3479015851 mini" onclick="location.href='?do=member&part=login&action=savemonth'">&nbsp;&nbsp;  
		<input type="button" value="导出到excel" class="qq3479015851 mini" onclick="location.href='record.php?do=member&part=login&action=doexcel';">
     </form>
    </td>
  </tr>
</table>
