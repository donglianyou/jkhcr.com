...
<td>
<input class="text" type="text" name="smtp_server" value="<?=$mail_config[smtp_server]?>"></td>
</tr>
<tr bgcolor="#ffffff">
<td>
参数二
</td>
<td><input class="text" type="text" name="smtp_serverport" value="<?php echo $mail_config[smtp_serverport];?>"></td>
</tr>
<tr bgcolor="#ffffff">
<td>
参数三
...
<center><input type="submit" value="提 交" class="qq3479015851 large" name="mail_submit"/>  </center>
</form>
