...
<td><?=$info['size']?></td>
<td><?=$info['volume']?></td>
<td><?php echo "<a class=\"act\" href=\"?part=restore&from=server&datafile_server=$info[filename]&action=dorestore\"".($info['version'] != $version ? " onclick=\"return confirm('该备份文件的系统版本与你当前使用的qq3479015851版本不同');\"" : '')." class=\"act\">导入</a>"?></td>
</tr>
...
<center>
  <input type="submit" name="submit" value="提 交" class="qq3479015851 large"/>
</center>
</form>
