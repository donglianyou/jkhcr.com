...
<div style="margin-top:3px">支持展会分类批量添加，多个分类以 | 隔开 <br />
...
<center>
<input type="submit" value="确认提交" name="<?=CURSCRIPT?>_submit" class="qq3479015851 mini" />　
<input type="button" onClick=history.back() value="返 回" class="qq3479015851 mini">
</center>
</form>
