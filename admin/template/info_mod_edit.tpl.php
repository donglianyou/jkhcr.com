...
<div id="<?=QQ3479015851_SOFTNAME?>">
    ...
    <?php if(is_array($options)){foreach ($options as $k=>$value){
        $get=$db->getRow("SELECT optionid,title,type,identifier FROM `{$db_qq3479015851}info_typeoptions` WHERE optionid = '$value'");
    	?>
...
<center>
<input type="submit" value="提 交" class="qq3479015851 large" <?php if($edit['id'] == 1) echo 'disabled'; ?>/>　
