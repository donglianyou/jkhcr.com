...
<tr class="firstr"><td class="h" style="text-align:right">管理选项</td><td class="h">&nbsp;</td></tr>
	...
	<tr bgcolor="#f5fbff">
        ...
        <td bgcolor="white">
            <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle">
    ...
    <td>&nbsp;</td>
    <td bgcolor="white">
    <input type="submit" value="提 交" style="margin-left:5px;" class="qq3479015851 mini" name="<?=CURSCRIPT?>_submit"/>&nbsp;&nbsp;
    <input type="button" onclick="javascript:history.go(-1)" class="qq3479015851 mini" value="返 回"/>
	</td>
    </tr>
</table>
</div>
