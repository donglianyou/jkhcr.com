...
<tr bgcolor="#ffffff">
  ...
  如: http://bj.qq3479015851.com.cn/
  <br />你可以设置二级域名绑定以上目录,但是需要服务器设置绑定并且需要在域名管理那里做设置指向
  <br /><font color="red">填写二级域名后你可以用&nbsp; <b style="color:#006acd; text-decoration:underline">http://bj.qq3479015851.com.cn/</b> &nbsp;来访问此分站</font></div></td>
</tr>
<tr bgcolor="#ffffff">
  <td>地图标注起始坐标：</td>
