...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
    ...
    <tbody id="hidden_settings_mobile" style="background-color:white;<?php if(empty($mobile[allowmobile])) echo 'display:none;'?>">
		...
		<tr>
			<td class="altbg1" ><b>手机版访问域名:</b><br /><span class="smalltxt">如http://wap.qq3479015851.com.cn<br />需将您指定的二级域名绑定/wap目录</span></td><td class="altbg2"><input name="settings[mobiledomain]" type="text" class="text" value="<?php echo $mobile[mobiledomain]; ?>"/>
			</td>
		</tr>
        <!--<tr>
...
<center><input name="<?=CURSCRIPT?>_submit" type="submit" value="提 交" class="qq3479015851 large"/></center>
</form>
