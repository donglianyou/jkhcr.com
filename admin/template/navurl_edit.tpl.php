...
<center>
<input type="submit" name="<?php echo CURSCRIPT; ?>_submit" value="保存修改" class="qq3479015851 mini" />　
<input type="button" onclick="location.href='?'" value="返 回" class="qq3479015851 mini">
</center>
</form>
