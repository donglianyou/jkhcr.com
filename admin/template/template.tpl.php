...
function simplevalue(){
	...
	$Obj('banmian_newsinfo').className='txt';
...
function newsinfovalue(){
	$Obj('banmian_simple').className='txt';
	$Obj('banmian_portal').className='txt';
	$Obj('banmian_classic').className='txt';
	$Obj('banmian_newsinfo').className='txt';
	$Obj('banmian_newsinfo').className='txt checked';
	$Obj('indextopinfo').value='<?php echo $defaultset[classic][indextopinfo];?>';
	$Obj('newinfo').value='<?php echo $defaultset[classic][newinfo];?>';
	$Obj('announce').value='<?php echo $defaultset[classic][announce];?>';
	$Obj('faq').value='<?php echo $defaultset[classic][faq];?>';
...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
    ...
    <tr bgcolor="white">
		...
		<?php 
			...
			if($k == 'simple'){
				$obj = 'onclick="simplevalue();$Obj(\'newsinfo_tpl\').style.display=\'none\';\'simple_tpl\').style.display=\'\';$Obj(\'classic_tpl\').style.display=\'none\';$Obj(\'portal_tpl\').style.display=\'none\';"';
			} elseif($k == 'portal') {
				$obj = 'onclick="portalvalue();$Obj(\'newsinfo_tpl\').style.display=\'none\';\'simple_tpl\').style.display=\'none\';$Obj(\'classic_tpl\').style.display=\'none\';$Obj(\'portal_tpl\').style.display=\'\';"';
			} elseif($k == 'classic') {
				$obj = 'onclick="classicvalue();$Obj(\'newsinfo_tpl\').style.display=\'none\';\'simple_tpl\').style.display=\'none\';$Obj(\'classic_tpl\').style.display=\'\';$Obj(\'portal_tpl\').style.display=\'none\';"';
			} elseif($k == 'newsinfo') {
				$obj = 'onclick="newsinfovalue();$Obj(\'newsinfo_tpl\').style.display=\'\';\'simple_tpl\').style.display=\'none\';$Obj(\'classic_tpl\').style.display=\'\';$Obj(\'portal_tpl\').style.display=\'none\';"';
			}
		?>
			<div class="showtpl2">
...
<center><input class="qq3479015851 large" value="提 交" name="<?=CURSCRIPT?>_submit" type="submit"></center>
</form>
