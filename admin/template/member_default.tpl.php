...
<?php if($if_corp == '1'){?>
  ...
  <tr bgcolor="#ffffff">
    ...
    <td>&nbsp;<input name="moneylower" class="txt" value="<?php echo $moneylower; ?>"> <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"></td>
    <td style="background-color:#f1f5f8" width="22%">金币 高于:</td>
    <td>&nbsp;<input name="moneyhigher" class="txt" value="<?php echo $moneyhigher; ?>"> <img src="../member/images/qq3479015851_icon_incomes.gif" align="absmiddle"></td>
  </tr>
  <tr bgcolor="#ffffff">
...
<center><input type="submit" value="搜 索" class="qq3479015851 large" /></center>
...
<center>
<input type="submit" value="提 交" class="qq3479015851 large"/></center>
</form>
