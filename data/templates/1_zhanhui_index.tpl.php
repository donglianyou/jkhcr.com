...
<div class="todaynews">
<ul>
                    <?php $i=1;$top_news	= qq3479015851_get_zhanhui(8,$zhanhui['catid'],NULL,NULL,NULL,NULL,$cityid); ?>                        <?php if(is_array($top_news)){foreach($top_news as $SystemGlobalcfm) { ?>                        <? if($i ==1) { ?>
 <div class="head">
