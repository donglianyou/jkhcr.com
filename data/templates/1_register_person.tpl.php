...
<td><input name="checkquestion[answer]" id="checkanswer" msgid="wer" value="" type="text" class="input" datatype="limit|ajax" require="true" msg="请填写验证答案" url="<?=$SystemGlobalcfm_global['SiteUrl']?>/javascript.php?part=chk_answer&id=<?=$checkquestion['id']?>"/>
...
<div id="xieyi">
<div class="xieye_nr">
<p>欢迎光临<?=$SystemGlobalcfm_global['SiteName']?>网站。<?=$SystemGlobalcfm_global['SiteName']?>致力于为您提供最优质、最便捷的服务。在访问<?=$SystemGlobalcfm_global['SiteName']?>的同时，也请您仔细阅读我们的协议条款。您需要同意该条款才能注册成为我们的用户。一经注册，将视为接受并遵守该条款的所有约定。<br /></p>
<p>
