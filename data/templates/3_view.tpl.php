...
<script type="text/javascript">uaredirect("<?=$SystemGlobalcfm_global['SiteUrl']?>/m/index.php?mod=goods&id=<?=$id?>");</script>
...
<link rel="stylesheet" href="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/style.css" />
<link rel="stylesheet" href="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/view.css" />
...
<script type="text/javascript" src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/goods.js"></script>
</head>
...
<?php } ?>    <script type="text/javascript" src="<?=$SystemGlobalcfm_global['SiteUrl']?>/template/global/messagebox.js"></script>
<div class="body1000">
<div class="clear"></div>
...
<img src="<?=$SystemGlobalcfm_global['SiteUrl']?><?=$goods['picture']?>" width="280" height="260" alt="" />
</div>
<div class="pro_mainInfo">
<div class="hd cfix">
<h2 title="<?=$goods['goodsname']?>"><? echo cutstr($goods['goodsname'],46); ?><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/remai.gif" alt=""  style="display:<? if($goods['remai'] != 1) { ?>none<?php } ?>"/>
<img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/tuijian.gif" alt=""  style="display:<? if($goods['tuijian'] != 1) { ?>none<?php } ?>"/>
<img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/cuxiao.gif" alt=""   style="display:<? if($goods['cuxiao'] != 1) { ?>none<?php } ?>"/>
</h2>
...
<div class="buy"><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/pro_show_24.png" alt=""  style="cursor:pointer" onclick="setbg('购买商品',510,480,'<?=$SystemGlobalcfm_global['SiteUrl']?>/box.php?part=goodsorder&id=<?=$goods['goodsid']?>');"  /></div>
<!--<div class="alipay"><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/pro_show_26.png" alt="" /></div>-->
<div class="service cfix"> 
<ul>
<li class="pic"><a href="tencent://message/?uin=<?=$goods['oicq']?>&Site=&Menu=yes"  target="_blank "><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/qq_online2.gif" alt="" border="0"/></a></li>
</ul> 
</div> 
...
<ul class="cfix">
                        <?php $relategoods = qq3479015851_get_goods(6,1,NULL,$goods['catid'],NULL,NULL,$city['cityid']); ?>                        <?php if(is_array($relategoods)){foreach($relategoods as $relate) { ?><li> <b><a href="<?=$relate['uri']?>" target=_blank><img src="<?=$SystemGlobalcfm_global['SiteUrl']?><?=$relate['picture']?>" alt=""  width="130" height="120"/></a></b> <span class="price"><?=$relate['nowprice']?><del>￥<?=$relate['old_price']?></del></span> <span class="title"><a href="<?=$relate['uri']?>"  target=_blank><? echo cutstr($relate['goodsname'],20); ?></a></span> </li>
<?php }} ?>
</ul>
</div>
</div>
<div class="ft"><a href="#top"><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/plugin/goods/template/images/returnTop_08.gif" alt="top" /></a></div>
