...
<ul>
<? if($friendlink['img']) { ?>
<ul class="image"><?php if(is_array($friendlink['img'])){foreach($friendlink['img'] as $SystemGlobalcfm) { ?><li><span class="imga"><a href="<?=$SystemGlobalcfm['uri']?>" class="f13" target="_blank" title="<?=$SystemGlobalcfm['name']?>"><img src="<?=$SystemGlobalcfm_global['SiteUrl']?><?=$SystemGlobalcfm['logo']?>" alt="<?=$SystemGlobalcfm['name']?>"></a></span><span class="txt"><a href="<?=$SystemGlobalcfm['uri']?>" target="_blank"><?=$SystemGlobalcfm['name']?></a></span></li>
<?php }} ?>
</ul>
<?php } ?>					
</ul>
