...
<ul class="mb5"> 
   ...
   <li>信用等级：<img align="absmiddle" src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/credit/<?=$store['credits']?>.gif" title="信用值:<?=$store['credit']?>" /></li> 
</ul> 
<!--机构基本信息-->
...
<!--身份及认证--> 
 ...
 <p><? if($store['per_certify'] == '1') { ?><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/person1.gif" alt="已通过身份证认证"/> 已通过身份证认证<?php } else { ?><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/person0.gif" alt="未通过身份证认证"/> 未通过身份证认证<?php } ?></p> 
 <p><? if($store['com_certify'] == '1') { ?><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/company1.gif" alt="已通过营业执照认证"/> 已通过营业执照认证<?php } else { ?><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/company0.gif" alt="未通过营业执照认证"/> 未通过营业执照认证<?php } ?></p> 
 </ul> 
<!--身份及认证--> 
        ...
        <div class="viewhit">
        <ul>
            <li>浏览人次：<span class="hit" id="hit"><img src="<?=$SystemGlobalcfm_global['SiteUrl']?>/images/loading.gif" border="0"></span>次</li>
