...
<title><?=$news['title']?> - <?=$SystemGlobalcfm_global['SiteName']?></title>
...
<link type="text/css" rel="stylesheet" href="template/css/style.css">
    ...
    <base href="<?=$SystemGlobalcfm_global['SiteUrl']?>" />
</head>
        ...
        <div class="mod_01">
            ...
            <div class="bd">
                <ul class="list_normal">
                    <?php $relate_news = qq3479015851_get_news(8,$news['catid']); ?>                    <?php if(is_array($relate_news)){foreach($relate_news as $SystemGlobalcfm) { ?>                    <li>
                    <span class="time">[<? echo GetTime($SystemGlobalcfm['begintime'],'m-d'); ?>]</span> 
                    <a href="index.php?mod=news&id=<?=$SystemGlobalcfm['id']?>"><?=$SystemGlobalcfm['title']?></a>
