...
</div><?php if(is_array($info_list)){foreach($info_list as $SystemGlobalcfm) { ?><div class="hover <? if($SystemGlobalcfm['upgrade_type']>1) { ?>ding<?php } ?>">
<span class="ltitle">
<a title="<?=$SystemGlobalcfm['title']?>" href="<?=$SystemGlobalcfm['uri']?>" target="_blank"  style="<? if($SystemGlobalcfm['ifred'] == 1) { ?>color:red;<?php } ?> <? if($SystemGlobalcfm['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>"><? echo cutstr($SystemGlobalcfm['contact_who'],10); ?>(<? echo cutstr($SystemGlobalcfm['title'],16); ?>)</a><? if($SystemGlobalcfm['img_count']) { ?><span class="img_count"><?=$SystemGlobalcfm['img_count']?>图</span><?php } if($SystemGlobalcfm['certify'] == 1) { ?><span class="certify">认证</span><?php } ?>
                        <div class="inforbox">
                            <div class="arrow"> <em></em> <span></span> </div>
                            <div class="tipsbox"> 
                            <a href="<?=$SystemGlobalcfm['uri']?>" class="ib-btn">查看详情</a>
                            <h3><?=$SystemGlobalcfm['contact_who']?>（<?=$SystemGlobalcfm['sex']?>，<? echo str_replace('.00','',$SystemGlobalcfm['age']); ?>）</h3>
                            <span class="tip">发布时间：<? echo GetTime($SystemGlobalcfm['begintime'],'Y-m-d'); ?></span>
                            <ul class="lists">
                            <li> <span>是否应届：</span> <?=$SystemGlobalcfm['graduate']?> </li>
                            <li> <span>区域：</span> <?=$SystemGlobalcfm['areaname']?> </li>
                            <li> <span>从业年限：</span>  <? echo str_replace('.00','',$SystemGlobalcfm['work_life']); ?></li>
                            <li> <span>最高学历：</span> <?=$SystemGlobalcfm['education']?> </li>
                            <li style="width:400px"> <span>求职意向：</span> <?=$SystemGlobalcfm['title']?> </li>
                            </ul>
                            
                            <dl class="content noborder">
                            <dt>自我描述：</dt>
                            <dd><? echo cutstr($SystemGlobalcfm['content'],'200','...'); ?></dd>
                            </dl>
...
<span class="lterm"><?=$SystemGlobalcfm['graduate']?>&nbsp;</span>
<span class="lxb"><?=$SystemGlobalcfm['sex']?>&nbsp;</span>
<span class="lage"><? echo str_replace('.00','',$SystemGlobalcfm['age']); ?>&nbsp;</span>
<span class="lxueli"><?=$SystemGlobalcfm['education']?>&nbsp;</span>
<span class="lexp"><? echo str_replace('.00','',$SystemGlobalcfm['work_life']); ?>&nbsp;</span>
</div>
<?php }} ?>
</ul>
</div>
