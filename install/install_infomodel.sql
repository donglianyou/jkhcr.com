INSERT INTO `dd_info_typemodels` (`id`, `name`, `displayorder`, `type`, `options`) VALUES
(1, '空模型', 0, 1, ''),
...
INSERT INTO `dd_info_typeoptions` (`optionid`, `classid`, `displayorder`, `title`, `description`, `identifier`, `type`, `rules`, `available`, `required`, `search`) VALUES
(1, 0, 0, '通用类', '', '', '', '', '0', '0', '0'),
(2, 0, 0, '房产类', '', '', '', '', '0', '0', '0'),
(3, 0, 0, '交友类', '', '', '', '', '0', '0', '0'),
(4, 0, 0, '求职招聘类', '', '', '', '', '0', '0', '0'),
...
DROP TABLE IF EXISTS `dd_information_2`;
CREATE TABLE IF NOT EXISTS `dd_information_2` (
...
DROP TABLE IF EXISTS `dd_information_6`;
CREATE TABLE IF NOT EXISTS `dd_information_6` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_7`;
CREATE TABLE IF NOT EXISTS `dd_information_7` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_8`;
CREATE TABLE IF NOT EXISTS `dd_information_8` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_9`;
CREATE TABLE IF NOT EXISTS `dd_information_9` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_10`;
CREATE TABLE IF NOT EXISTS `dd_information_10` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_11`;
CREATE TABLE IF NOT EXISTS `dd_information_11` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_12`;
CREATE TABLE IF NOT EXISTS `dd_information_12` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_13`;
CREATE TABLE IF NOT EXISTS `dd_information_13` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_14`;
CREATE TABLE IF NOT EXISTS `dd_information_14` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_15`;
CREATE TABLE IF NOT EXISTS `dd_information_15` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `mileage` mediumint(7) NOT NULL DEFAULT '0',
  `car_year` tinyint(1) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_16`;
CREATE TABLE IF NOT EXISTS `dd_information_16` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `prices` mediumint(7) NOT NULL DEFAULT '0',
  `new_old` tinyint(1) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_18`;
CREATE TABLE IF NOT EXISTS `dd_information_18` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_19`;
CREATE TABLE IF NOT EXISTS `dd_information_19` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `sex` tinyint(1) NOT NULL DEFAULT '0',
  `age` mediumint(7) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_20`;
CREATE TABLE IF NOT EXISTS `dd_information_20` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_21`;
CREATE TABLE IF NOT EXISTS `dd_information_21` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_22`;
CREATE TABLE IF NOT EXISTS `dd_information_22` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_23`;
CREATE TABLE IF NOT EXISTS `dd_information_23` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `position` tinyint(1) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_24`;
CREATE TABLE IF NOT EXISTS `dd_information_24` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `position` tinyint(1) NOT NULL DEFAULT '0',
  `acreage` mediumint(7) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_25`;
CREATE TABLE IF NOT EXISTS `dd_information_25` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
  `acreage` mediumint(7) NOT NULL DEFAULT '0',
  `prices` mediumint(7) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_26`;
CREATE TABLE IF NOT EXISTS `dd_information_26` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_27`;
CREATE TABLE IF NOT EXISTS `dd_information_27` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `dd_information_28`;
CREATE TABLE IF NOT EXISTS `dd_information_28` (
  `iid` mediumint(7) NOT NULL AUTO_INCREMENT,
  `id` int(10) NOT NULL DEFAULT '0',
