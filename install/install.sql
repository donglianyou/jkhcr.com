DROP TABLE IF EXISTS `dd_about`;
CREATE TABLE IF NOT EXISTS `dd_about` (
...
INSERT INTO `dd_about` (`id`, `typename`, `content`, `displayorder`, `pubdate`, `dir_type`, `dir_typename`) VALUES (1, '网站简介', '在这里填写网站简介，填写完成后保存提交即可', 1, 0, 2, 'wangzhanjianjie'),
...
DROP TABLE IF EXISTS `dd_province`;
CREATE TABLE IF NOT EXISTS `dd_province` (
...
CREATE TABLE IF NOT EXISTS `dd_area` (
...
DROP TABLE IF EXISTS `dd_street`;
CREATE TABLE IF NOT EXISTS `dd_street` (
...
DROP TABLE IF EXISTS `dd_admin_record_action`;
CREATE TABLE IF NOT EXISTS `dd_admin_record_action` (
...
DROP TABLE IF EXISTS `dd_admin_record_login`;
CREATE TABLE IF NOT EXISTS `dd_admin_record_login` (
  `id` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_admin_type`;
CREATE TABLE IF NOT EXISTS `dd_admin_type` (
...
DROP TABLE IF EXISTS `dd_announce`;
CREATE TABLE IF NOT EXISTS `dd_announce` (
  `id` int(10) NOT NULL auto_increment,
  `title` varchar(100) NOT NULL,
...
DROP TABLE IF EXISTS `dd_badwords`;
CREATE TABLE IF NOT EXISTS `dd_badwords` (
  `words` mediumtext NOT NULL,
  `view` varchar(100) NOT NULL,
  `ifcheck` tinyint(1) NOT NULL
) TYPE=MyISAM;

INSERT INTO `dd_badwords` (`words`, `view`, `ifcheck`) VALUES ('激情交友', '**', 1);

DROP TABLE IF EXISTS `dd_cache`;
...
INSERT INTO `dd_cache` (`id`, `page`, `time`, `open`) VALUES (1, 'site', 0, 0),
(2, 'info', 0, 0),
(3, 'list', 0, 0),
(4, 'aboutus', 0, 0),
(5, 'announce', 0, 0),
...
DROP TABLE IF EXISTS `dd_certification`;
CREATE TABLE IF NOT EXISTS `dd_certification` (
  `id` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_channel`;
CREATE TABLE IF NOT EXISTS `dd_channel` (
  `catid` mediumint(6) NOT NULL auto_increment,
  `if_view` tinyint(1) NOT NULL default '1',
  `color` char(10) NOT NULL,
  `catname` varchar(32) NOT NULL,
...
DROP TABLE IF EXISTS `dd_checkanswer`;
CREATE TABLE IF NOT EXISTS `dd_checkanswer` (
  `id` smallint(3) NOT NULL auto_increment,
...
INSERT INTO `dd_config` (`description`, `value`, `type`) VALUES
...
('cfg_upimg_watermark_text', 'qq3479015851', 'config'),
...
DROP TABLE IF EXISTS `dd_corp`;
CREATE TABLE IF NOT EXISTS `dd_corp` (
...
DROP TABLE IF EXISTS `dd_coupon`;
CREATE TABLE IF NOT EXISTS `dd_coupon` (
...
DROP TABLE IF EXISTS `dd_coupon_category`;
CREATE TABLE IF NOT EXISTS `dd_coupon_category` (
...
DROP TABLE IF EXISTS `dd_crons`;
CREATE TABLE IF NOT EXISTS `dd_crons` (
...
INSERT INTO `dd_crons` (`cronid`, `name`, `lastrun`, `nextrun`, `day`) VALUES
(1, 'advertisement', 1478538062, 1478620800, 1),
(2, 'levelup', 1478538062, 1478620800, 1);

DROP TABLE IF EXISTS `dd_faq`;
CREATE TABLE IF NOT EXISTS `dd_faq` (
...
DROP TABLE IF EXISTS `dd_faq_type`;
CREATE TABLE IF NOT EXISTS `dd_faq_type` (
  `id` tinyint(5) NOT NULL auto_increment,
  `typename` char(50) NOT NULL,
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;

INSERT INTO `dd_faq_type` (`id`, `typename`) VALUES (1, '置顶与刷新'),
(2, '信息发布与删除'),
(4, '认证服务'),
(5, '用户注册与登录'),
(6, '防骗常识');

DROP TABLE IF EXISTS `dd_flink`;
CREATE TABLE IF NOT EXISTS `dd_flink` (
  `id` smallint(5) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_flink_type`;
CREATE TABLE IF NOT EXISTS `dd_flink_type` (
  `id` mediumint(8) NOT NULL auto_increment,
  `typename` varchar(50) NOT NULL default '',
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;

INSERT INTO `dd_flink_type` (`id`, `typename`) VALUES (1, '门户网站'),
(2, '分类信息'),
(4, '论坛博客'),
(8, '其它类别');

DROP TABLE IF EXISTS `dd_focus`;
CREATE TABLE IF NOT EXISTS `dd_focus` (
  `id` smallint(5) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_goods_category`;
CREATE TABLE IF NOT EXISTS `dd_goods_category` (
  `catid` mediumint(6) NOT NULL auto_increment,
  `if_view` tinyint(1) NOT NULL default '1',
  `color` char(10) NOT NULL,
  `catname` varchar(32) NOT NULL,
...
DROP TABLE IF EXISTS `dd_goods_order`;
CREATE TABLE IF NOT EXISTS `dd_goods_order` (
  `id` int(10) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_group_category`;
CREATE TABLE IF NOT EXISTS `dd_group_category` (
  `cate_id` smallint(3) NOT NULL auto_increment,
  `cate_name` varchar(100) NOT NULL,
  `cate_view` tinyint(1) NOT NULL default '1',
  `cate_order` smallint(3) NOT NULL default '0',
...
INSERT INTO `dd_group_category` (`cate_id`, `cate_name`, `cate_view`, `cate_order`) VALUES (1, '家居团', 1, 1),
(2, '婚庆团', 1, 2),
(3, '买车团', 1, 3),
(4, '建材团', 1, 4),
(5, '找驴友', 1, 5),
...
DROP TABLE IF EXISTS `dd_group_signin`;
CREATE TABLE IF NOT EXISTS `dd_group_signin` (
...
DROP TABLE IF EXISTS `dd_info_img`;
CREATE TABLE IF NOT EXISTS `dd_info_img` (
  `id` int(10) NOT NULL auto_increment,
  ...
  `prewidth`  smallint(6) NOT NULL DEFAULT 0 ,
  `preheight`  smallint(6) NOT NULL DEFAULT 0 ,
  PRIMARY KEY  (`id`),
  KEY `infoid` (`infoid`)
) TYPE=MyISAM;

DROP TABLE IF EXISTS `dd_info_report`;
CREATE TABLE IF NOT EXISTS `dd_info_report` (
  `id` int(8) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_info_typemodels`;
CREATE TABLE IF NOT EXISTS `dd_info_typemodels` (
...
DROP TABLE IF EXISTS `dd_info_typeoptions`;
CREATE TABLE IF NOT EXISTS `dd_info_typeoptions` (
...
DROP TABLE IF EXISTS `dd_information`;
CREATE TABLE IF NOT EXISTS `dd_information` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dd_insidelink`;
CREATE TABLE IF NOT EXISTS `dd_insidelink` (
  `id` mediumint(8) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_jswizard`;
CREATE TABLE IF NOT EXISTS `dd_jswizard` (
  `id` smallint(5) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_lifebox`;
CREATE TABLE IF NOT EXISTS `dd_lifebox` (
...
DROP TABLE IF EXISTS `dd_mail_sendlist`;
CREATE TABLE IF NOT EXISTS `dd_mail_sendlist` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dd_mail_template`;
CREATE TABLE IF NOT EXISTS `dd_mail_template` (
...
INSERT INTO `dd_mail_template` (`template_id`, `is_sys`, `template_code`, `is_html`, `template_subject`, `template_content`, `last_modify`, `last_send`) VALUES
...
CREATE TABLE IF NOT EXISTS `dd_member` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `userid` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `dd_member_album`;
CREATE TABLE IF NOT EXISTS `dd_member_album` (
  `id` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_category`;
CREATE TABLE IF NOT EXISTS `dd_member_category` (
  `id` int(11) NOT NULL auto_increment,
  `userid` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `dd_member_comment`;
CREATE TABLE IF NOT EXISTS `dd_member_comment` (
  `id` int(10) NOT NULL auto_increment,
  `userid` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `dd_member_docu`;
CREATE TABLE IF NOT EXISTS `dd_member_docu` (
  `id` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_docutype`;
CREATE TABLE IF NOT EXISTS `dd_member_docutype` (
...
INSERT INTO `dd_member_docutype` (`typeid`, `typename`, `arrid`, `ifview`, `displayorder`) VALUES (1, '商家资讯', 1, 2, 1),
(2, '优惠促销', 1, 2, 2);

DROP TABLE IF EXISTS `dd_member_level`;
CREATE TABLE IF NOT EXISTS `dd_member_level` (
  `id` tinyint(5) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_pm`;
CREATE TABLE IF NOT EXISTS `dd_member_pm` (
  `id` int(10) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_record_login`;
CREATE TABLE IF NOT EXISTS `dd_member_record_login` (
 `id` int(11) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_record_use`;
CREATE TABLE IF NOT EXISTS `dd_member_record_use` (
  `id` int(8) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_member_tpl`;
CREATE TABLE IF NOT EXISTS `dd_member_tpl` (
  `id` smallint(3) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dd_member_tpl` (`id`, `if_view`, `tpl_name`, `tpl_path`, `displayorder`, `edittime`) VALUES
...
DROP TABLE IF EXISTS `dd_member_wx`;
CREATE TABLE IF NOT EXISTS `dd_member_wx` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dd_mobile_gg`;
CREATE TABLE IF NOT EXISTS `dd_mobile_gg` (
  `id` smallint(5) NOT NULL AUTO_INCREMENT,
  `typeid` tinyint(1) NOT NULL,
  `image` varchar(100) NOT NULL,
  `url` varchar(100) NOT NULL,
...
INSERT INTO `dd_mobile_gg` (`id`, `typeid`, `image`, `url`, `words`, `pubdate`, `displayorder`) VALUES
...
DROP TABLE IF EXISTS `dd_mobile_nav`;
CREATE TABLE IF NOT EXISTS `dd_mobile_nav` (
  `id` smallint(5) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `dd_mobile_nav` (`id`, `title`, `url`, `color`, `ico`, `flag`, `target`, `isview`, `displayorder`, `createtime`, `typeid`) VALUES
...
(4, '首页', 'index.php?mod=index', '', '', 'index', '_self', 2, 1, 1469521176, 1),
...
DROP TABLE IF EXISTS `dd_navurl`;
CREATE TABLE IF NOT EXISTS `dd_navurl` (
...
CREATE TABLE IF NOT EXISTS `dd_news` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dd_payapi`;
CREATE TABLE IF NOT EXISTS `dd_payapi` (
...
INSERT INTO `dd_payapi` (`payid`, `paytype`, `buytype`, `myorder`, `payfee`, `payuser`, `partner`, `paykey`, `appid`, `appkey`, `paylogo`, `paysay`, `payname`, `isclose`, `payemail`) VALUES
...
DROP TABLE IF EXISTS `dd_payrecord`;
CREATE TABLE IF NOT EXISTS `dd_payrecord` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dd_plugin`;
...
DROP TABLE IF EXISTS `dd_telephone`;
CREATE TABLE IF NOT EXISTS `dd_telephone` (
  `id` smallint(4) NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dd_sms_sendlist`;
CREATE TABLE IF NOT EXISTS `dd_sms_sendlist` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `mobile` varchar(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `dd_template` (
  `filepath` varchar(250) NOT NULL,
  `content` longtext NOT NULL
) TYPE=MyISAM;

DROP TABLE IF EXISTS `dd_upload`;
CREATE TABLE IF NOT EXISTS `dd_upload` (
  `id` int(11) NOT NULL auto_increment,
  `title` varchar(100) NOT NULL default '',
