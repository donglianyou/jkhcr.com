INSERT INTO `dd_category` (`catid`, `if_view`, `color`, `catname`, `icon`, `usecoin`, `title`, `keywords`, `description`, `parentid`, `modid`, `catorder`, `if_upimg`, `if_mappoint`, `dir_type`, `dir_typename`, `template`, `template_info`, `html_dir`, `htmlpath`, `gid`) VALUES
