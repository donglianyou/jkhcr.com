...
INSERT INTO `dd_goods_category` (`catid`, `if_view`, `color`, `catname`, `title`, `keywords`, `description`, `parentid`, `catorder`) VALUES (1, 2, '', '运动/户外/休闲', '运动/户外/休闲', '运动/户外/休闲', '运动/户外/休闲', 0, 1),
