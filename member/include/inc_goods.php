...
if (submit_check('goods_submit')) {
	...
	if ($_FILES[$name_file]['name']) {
		...
		$SystemGlobalcfm_image = (empty($id) ? start_upload($name_file, $destination, 0, $SystemGlobalcfm_qq3479015851['cfg_goods_limit']['width'], $SystemGlobalcfm_qq3479015851['cfg_goods_limit']['height']) : start_upload($name_file, $destination, 0, $SystemGlobalcfm_qq3479015851['cfg_goods_limit']['width'], $SystemGlobalcfm_qq3479015851['cfg_goods_limit']['height'], $picture, $pre_picture));
