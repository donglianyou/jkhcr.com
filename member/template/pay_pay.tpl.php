...
<div class="container">
    ...
    <div id="main" class="main section-setting">
            <div class="clearfix main-inner" >
                                                ...
                                                <div class="formrow-enter">
                                                    <ul class="clearfix paymentlist">
                                                     ...
                                                     foreach($opened_pay_api as $k => $v){?>
                                                        <li id="li<?=$v['paytype']?>" <?php if($v['payid'] == 5){?>class="selected"<?php }?>>
                                                            ...
                                                            <input id="payment_<?=$v['paytype']?>" class="radio" type="radio" name="payid" onClick="selPayment()" value="<?=$v['payid']?>"  <?php if($v['payid'] == 5) echo 'checked="checked"'; ?> />
                                                        ...
                                                        if (varPayment[i].checked) {
                                                            switch (varPayment[i].value) {
                                                               ...
                                                               case "5":
                                                                    ...
                                                                    setCssClass("lichinabank", "");
																	setCssClass("liwxpay", "");
                                                                    setCssClass("liwxpay", "selected");
                                                                    $obj('paytype').innerHTML = '(你选择了微信支付)';
                                                                    break;
                ...
                <?php include qq3479015851_tpl('inc_sidebar');?>
            </div>
        </div>
        
    <?php include qq3479015851_tpl('inc_foot');?>
